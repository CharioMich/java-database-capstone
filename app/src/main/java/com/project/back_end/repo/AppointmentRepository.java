...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    @Query("""
           ...
           LEFT JOIN FETCH d.availableTimes t
           WHERE d.id = :doctorId
    ...
    @Modifying  // performs a write operation (UPDATE/DELETE) not just READ like an average JPQL Query and must be transactional.
    @Transactional
     ...
     * ordered by the appointment time in ascending order.
     *
     * @param patientId The ID of the patient.
     * @param status    The status of the appointments to retrieve.
     * @return An ordered list of matching appointments.
     */
