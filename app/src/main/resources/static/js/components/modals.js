// modals.js
import {loginPatient, signupPatient} from '../patientDashboard.js';
...
export function openModal(type) {
  ...
  if (type === 'addDoctor') {
    ...
    modalContent = `
        ...
        <button class="dashboard-btn" id="loginBtn" onclick="loginPatient">Login</button>
      `;
  }
...
//
//  if (!modalBody) {
//    console.error("Modal body container not found. Cannot render content.");
//    return;
//  }
//
...
//  }
//
//  // Render modal content and show modal
